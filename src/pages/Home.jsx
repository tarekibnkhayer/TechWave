...
const Home = () => {
  ...
  useEffect(() => {
    fetch(
      `https://techwave-server-h2fyqkqh6-tarek-ibn-khayers-projects.vercel.app/trending/${yes}`
    )
      .then((res) => res.json())
      .then((data) => {
  ...
  return (
    <div style={modeStyle}>
      ...
      <div className="lg:max-w-6xl  md:max-w-2xl max-w-xs mx-auto mt-20">
        ...
        <p className="text-center text-5xl my-10 text-yellow-900 font-Raleway font-extrabold">
